...
public class PA_Items {
    ...
    public static final RegistryObject<MusicDiscItem> MUSIC_DISC_SKIZZIK = PA_Registry.ITEMS.register("music_disc_skizzik", () -> new MusicDiscItem(14, PA_SoundEvents.MUSIC_SKIZZIK_LAZY.get(), (new Item.Properties()).stacksTo(1).tab(PA_Registry.MAIN_SKIZZIK_TAB).rarity(Rarity.EPIC)));
    ...
    public static final RegistryObject<BucketItem> MAPLE_SYRUP_BUCKET = PA_Registry.ITEMS.register("maple_syrup_bucket", () -> new BucketItem(Fluids.WATER /*PA_Fluids.MAPLE_SYRUP*/, (new Item.Properties()).craftRemainder(Items.BUCKET).stacksTo(1).tab(ItemGroup.TAB_MISC)));
