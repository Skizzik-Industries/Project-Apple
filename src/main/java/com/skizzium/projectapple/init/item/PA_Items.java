...
public class PA_Items {
    ...
    public static final RegistryObject<ForgeSpawnEggItem> FRIENDLY_SKIZZO_SPAWN_EGG = PA_Registry.ITEMS.register("friendly_skizzo_spawn_egg", () -> new ForgeSpawnEggItem(PA_Entities.FRIENDLY_SKIZZO, 0XFF0000, 0X330000, (new Item.Properties()).tab(PA_Registry.MAIN_SKIZZIK_TAB)));

    public static final RegistryObject<ForgeSpawnEggItem> SKIZZIE_SPAWN_EGG = PA_Registry.ITEMS.register("skizzie_spawn_egg", () -> new ThemeableSpawnEgg(PA_Entities.SKIZZIE, PA_ThemeableSpawnEggColors.Primary.SKIZZIE_PRIMARY, PA_ThemeableSpawnEggColors.Secondary.SKIZZIE_SECONDARY, (new Item.Properties()).tab(PA_Registry.MAIN_SKIZZIK_TAB)));
    public static final RegistryObject<ForgeSpawnEggItem> KABOOM_SKIZZIE_SPAWN_EGG = PA_Registry.ITEMS.register("kaboom_skizzie_spawn_egg", () -> new ThemeableSpawnEgg(PA_Entities.KABOOM_SKIZZIE, PA_ThemeableSpawnEggColors.Primary.SKIZZIE_PRIMARY, PA_ThemeableSpawnEggColors.Secondary.KA_BOOM_SKIZZIE_SECONDARY, (new Item.Properties()).tab(PA_Registry.MAIN_SKIZZIK_TAB)));
    public static final RegistryObject<ForgeSpawnEggItem> WITCH_SKIZZIE_SPAWN_EGG = PA_Registry.ITEMS.register("witch_skizzie_spawn_egg", () -> new ThemeableSpawnEgg(PA_Entities.WITCH_SKIZZIE, PA_ThemeableSpawnEggColors.Primary.SKIZZIE_PRIMARY, 0X5349438, (new Item.Properties()).tab(PA_Registry.MAIN_SKIZZIK_TAB)));
    ...
    public static final RegistryObject<ForgeSpawnEggItem> SKIZZO_SPAWN_EGG = PA_Registry.ITEMS.register("skizzo_spawn_egg", () -> new ThemeableSpawnEgg(PA_Entities.SKIZZO, PA_ThemeableSpawnEggColors.Primary.SKIZZO_PRIMARY, 0X330000, (new Item.Properties()).tab(PA_Registry.MAIN_SKIZZIK_TAB)));
