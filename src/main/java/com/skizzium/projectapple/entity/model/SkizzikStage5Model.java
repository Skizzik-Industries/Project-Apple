...
@OnlyIn(Dist.CLIENT)
public class SkizzikStage5Model<T extends Skizzik> extends ListModel<T> {
	private final ModelPart[] body;
	private final ModelPart[] block_holders;
	...
	public SkizzikStage5Model() {
		...
		block_holders[0] = (new ModelPart(this)).setTexSize(this.texWidth, this.texHeight);
		...
		block_holders[1] = (new ModelPart(this)).setTexSize(this.texWidth, this.texHeight);
		...
		block_holders[2] = (new ModelPart(this)).setTexSize(this.texWidth, this.texHeight);
