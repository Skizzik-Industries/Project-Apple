...
public class SkizzieModel<T extends LivingEntity> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        part.addOrReplaceChild("lowerBody", CubeListBuilder.create().texOffs(13, 26).addBox(-4.0F, 0.0F, 0.0F, 3.0F, 6.0F, 3.0F, true), PartPose.offsetAndRotation(2.0F, 17.0F, -0.5F, 0.5F, 0.0F, 0.0F));
        part.addOrReplaceChild("upperBody", CubeListBuilder.create().texOffs(0, 22).addBox(-4.0F, 0.0F, 0.0F, 3.0F, 10.0F, 3.0F, true)
