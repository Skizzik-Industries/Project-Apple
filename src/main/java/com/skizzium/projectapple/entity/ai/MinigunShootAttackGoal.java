...
public class MinigunShootAttackGoal<T extends MonsterEntity & IRangedAttackMob> extends Goal {
    ...
    public boolean canUse() {
        return this.mob.getTarget() != null && this.isHoldingMinigun();
    }
    ...
    public boolean canContinueToUse() {
        return (this.canUse() || !this.mob.getNavigation().isDone()) && this.isHoldingMinigun();
    }
    ...
    public void tick() {
        ...
        if (entity != null) {
            double distance = this.mob.distanceToSqr(entity.getX(), entity.getY(), entity.getZ());
            boolean flag = this.mob.getSensing().canSee(entity);
            ...
            if (this.mob.isUsingItem()) {
                if (!flag && this.seeTime < -60) {
                    ...
                    if (i >= 20) {
                        this.mob.stopUsingItem();
                        this.mob.performRangedAttack(entity, BowItem.getPowerForTime(i));
