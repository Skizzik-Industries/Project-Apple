...
@OnlyIn(Dist.CLIENT)
public class OldSkizzikGlowLayer<T extends Skizzik, M extends EntityModel<T>> extends RenderLayer<T, M> {
    ...
    public OldSkizzikGlowLayer(RenderLayerParent<T, M> renderer) {
        super(renderer);
    }
