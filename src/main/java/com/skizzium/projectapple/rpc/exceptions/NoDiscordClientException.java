 ...
 */
package com.skizzium.projectapple.rpc.exceptions;

import com.skizzium.projectapple.rpc.entities.DiscordBuild;

/**
 * An exception thrown when an {@link com.skizzium.projectapple.rpc.IPCClient IPCClient}
 * when the client cannot find the proper application to use for RichPresence when
 * attempting to {@link com.skizzium.projectapple.rpc.IPCClient#connect(DiscordBuild...) connect}.<p>
 * <p>
