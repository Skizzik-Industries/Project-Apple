 ...
 */
package com.skizzium.projectapple.rpc.entities;
...
/**
 * A data-packet received from Discord via an {@link com.skizzium.projectapple.rpc.IPCClient IPCClient}.<br>
 * These can be handled via an implementation of {@link com.skizzium.projectapple.rpc.IPCListener IPCListener}.
 *
...
public class Packet {
     ...
     * and the {@link com.skizzium.projectapple.rpc.IPCClient IPCClient}
     * connected.
     */
    public enum OpCode {
