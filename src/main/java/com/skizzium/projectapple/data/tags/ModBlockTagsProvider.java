...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        tag(PA_Tags.Blocks.DRAGON_IMMUNE).addTag(PA_Tags.Blocks.SKIZZIK_COMMAND_BLOCKS);
        tag(PA_Tags.Blocks.DRAGON_IMMUNE).add(PA_Blocks.SKIZZIK_LOOT_BAG.get());

        tag(PA_Tags.Blocks.WITHER_IMMUNE).addTag(PA_Tags.Blocks.SKIZZIK_COMMAND_BLOCKS);
        ...
        tag(PA_Tags.Blocks.RAINBOW_SWORD_IMMUNE).add(Blocks.SPAWNER, Blocks.STRUCTURE_VOID, Blocks.DRAGON_EGG, PA_Blocks.RAINBOW_GEM_BLOCK.get(), PA_Blocks.RAINBOW_ORE.get(), PA_Blocks.SKIZZIK_HEAD_WITH_GEMS.get(), PA_Blocks.SKIZZIK_WALL_HEAD_WITH_GEMS.get());

        tag(PA_Tags.Blocks.CORRUPTION_IMMUNE).addTag(PA_Tags.Blocks.RAINBOW_SWORD_IMMUNE);
        tag(PA_Tags.Blocks.CORRUPTION_IMMUNE).add(Blocks.AIR, Blocks.CAVE_AIR, Blocks.VOID_AIR, PA_Blocks.CORRUPTED_BLOCK.get());
