...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> SKIZZIE_STATUE = register("skizzie_statue", () -> new SkizzieStatue(AbstractBlock.Properties.of(Material.STONE, MaterialColor.STONE).strength(1.5F,6.0F).noOcclusion().sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).harvestLevel(0).requiresCorrectToolForDrops()), ItemGroup.TAB_BUILDING_BLOCKS, Rarity.UNCOMMON, false);
    ...
    public static final RegistryObject<PressurePlateBlock> CANDY_PRESSURE_PLATE = register("candy_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, AbstractBlock.Properties.of(Material.WOOD, MaterialColor.CRIMSON_STEM).strength(0.5F).sound(SoundType.SLIME_BLOCK).noCollission()), ItemGroup.TAB_BUILDING_BLOCKS, Rarity.COMMON, false);
    public static final RegistryObject<WoodButtonBlock> CANDY_BUTTON = register("candy_button", () -> new WoodButtonBlock(AbstractBlock.Properties.of(Material.DECORATION, MaterialColor.CRIMSON_STEM).strength(0.5F).sound(SoundType.SLIME_BLOCK).noCollission()), ItemGroup.TAB_BUILDING_BLOCKS, Rarity.COMMON, false);
    ...
    public static final RegistryObject<FenceGateBlock> CANDY_FENCE_GATE = register("candy_fence_gate", () -> new FenceGateBlock(AbstractBlock.Properties.copy(CANDY_PLANKS.get())), ItemGroup.TAB_BUILDING_BLOCKS, Rarity.COMMON, false);

    public static final RegistryObject<TrapDoorBlock> CANDY_TRAPDOOR = register("candy_trapdoor", () -> new TrapDoorBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.CRIMSON_STEM).strength(3.0F).harvestTool(ToolType.AXE).sound(SoundType.SLIME_BLOCK).noOcclusion()), ItemGroup.TAB_BUILDING_BLOCKS, Rarity.COMMON, false);
    public static final RegistryObject<DoorBlock> CANDY_DOOR = register("candy_door", () -> new DoorBlock(AbstractBlock.Properties.copy(CANDY_TRAPDOOR.get())), ItemGroup.TAB_BUILDING_BLOCKS, Rarity.COMMON, false);
