...
import net.uskizzik.skizzik.procedures.FriendlyWitchSkizzie3RightClickedOnEntityProcedure;
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				FriendlyWitchSkizzie3RightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		...
		public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing,
			...
			IVertexBuilder ivertexbuilder = bufferIn
					.getBuffer(RenderType.getEyes(new ResourceLocation("skizzik:textures/friendly_witch_skizzie_3_glow.png")));
