...
import net.uskizzik.skizzik.procedures.KaBoomSkizzieRightClickedOnEntityProcedure;
import net.uskizzik.skizzik.procedures.KaBoomSkizziePlayerCollidesWithThisEntityProcedure;
...
public class KaBoomSkizzieEntity extends SkizzikModElements.ModElement {
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.5999999999999999f))
						.build("ka_boom_skizzie").setRegistryName("ka_boom_skizzie");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -65536, -16724788, new Item.Properties().group(TemplateTabItemGroup.tab))
				.setRegistryName("ka_boom_skizzie_spawn_egg"));
	}
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelskizzie(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("skizzik:textures/ka_boom_skizzie.png");
					}
				};
			});
		}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				KaBoomSkizzieRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				KaBoomSkizziePlayerCollidesWithThisEntityProcedure.executeProcedure($_dependencies);
			}
		}
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		...
		public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing,
			...
			IVertexBuilder ivertexbuilder = bufferIn.getBuffer(RenderType.getEyes(new ResourceLocation("skizzik:textures/ka_boom_skizzie_glow.png")));
