...
import net.uskizzik.skizzik.procedures.WitchSkizzie2RightClickedOnEntityProcedure;
import net.uskizzik.skizzik.procedures.WitchSkizzie2PlayerCollidesWithThisEntityProcedure;
...
public class WitchSkizzie2Entity extends SkizzikModElements.ModElement {
	public static EntityType entity = null;
	public WitchSkizzie2Entity(SkizzikModElements instance) {
		super(instance, 28);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.5999999999999999f))
						.build("witch_skizzie_2").setRegistryName("witch_skizzie_2");
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelwitch_skizzie(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("skizzik:textures/witch_skizzie_2.png");
					}
				};
			});
		}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				WitchSkizzie2RightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("sourceentity", sourceentity);
				WitchSkizzie2PlayerCollidesWithThisEntityProcedure.executeProcedure($_dependencies);
			}
		}
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		...
		public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing,
			...
			IVertexBuilder ivertexbuilder = bufferIn.getBuffer(RenderType.getEyes(new ResourceLocation("skizzik:textures/witch_skizzie_2_glow.png")));
