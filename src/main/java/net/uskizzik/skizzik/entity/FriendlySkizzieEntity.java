...
import net.uskizzik.skizzik.procedures.FriendlySkizzieRightClickedOnEntityProcedure;
...
public class FriendlySkizzieEntity extends SkizzikModElements.ModElement {
	public static EntityType entity = null;
	public FriendlySkizzieEntity(SkizzikModElements instance) {
		super(instance, 56);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.5999999999999999f))
						.build("friendly_skizzie").setRegistryName("friendly_skizzie");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -16724737, -16711681, new Item.Properties().group(TemplateTabItemGroup.tab))
				.setRegistryName("friendly_skizzie_spawn_egg"));
	}
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelskizzie(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("skizzik:textures/friendly_skizzie.png");
					}
				};
			});
		}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				FriendlySkizzieRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
