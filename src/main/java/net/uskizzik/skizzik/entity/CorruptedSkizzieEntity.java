...
import net.uskizzik.skizzik.procedures.CorruptedSkizzieRightClickedOnEntityProcedure;
import net.uskizzik.skizzik.procedures.CorruptedSkizziePlayerCollidesWithThisEntityProcedure;
import net.uskizzik.skizzik.procedures.CorruptedSkizzieOnEntityTickUpdateProcedure;
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				CorruptedSkizzieOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				CorruptedSkizzieRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("sourceentity", sourceentity);
				CorruptedSkizziePlayerCollidesWithThisEntityProcedure.executeProcedure($_dependencies);
			}
		}
