...
import net.uskizzik.skizzik.procedures.Skizzik4ThisEntityKillsAnotherOneProcedure;
import net.uskizzik.skizzik.procedures.Skizzik4PlayerCollidesWithThisEntityProcedure;
import net.uskizzik.skizzik.procedures.Skizzik4OnInitialEntitySpawnProcedure;
import net.uskizzik.skizzik.procedures.Skizzik4EntityIsHurtProcedure;
import net.uskizzik.skizzik.procedures.Skizzik4EntityDiesProcedure;
...
public class Skizzik4Entity extends SkizzikModElements.ModElement {
	public static EntityType entity = null;
	public Skizzik4Entity(SkizzikModElements instance) {
		super(instance, 102);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(3f, 4f)).build("skizzik_4")
						.setRegistryName("skizzik_4");
	...
	private static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelskizzik_4(), 1f) {
					@Override
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				Skizzik4EntityIsHurtProcedure.executeProcedure($_dependencies);
			}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				Skizzik4EntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("world", world);
				Skizzik4OnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
			...
			Entity sourceentity = this;
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				Skizzik4ThisEntityKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class Modelskizzik_4 extends EntityModel<Entity> {
		private final ModelRenderer body;
		private final ModelRenderer body2;
		private final ModelRenderer head1;
		private final ModelRenderer head2;
		public Modelskizzik_4() {
			textureWidth = 256;
			textureHeight = 256;
			...
			head2.setTextureOffset(0, 62).addBox(-14.0F, -29.0F, -6.0F, 12.0F, 12.0F, 12.0F, 0.0F, false);
		}
