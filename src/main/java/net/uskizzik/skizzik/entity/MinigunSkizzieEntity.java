...
import net.uskizzik.skizzik.procedures.SkizziePlayerCollidesWithThisEntityProcedure;
import net.uskizzik.skizzik.procedures.SkizzieEntityDiesProcedure;
import net.uskizzik.skizzik.procedures.MinigunSkizzieRightClickedOnEntityProcedure;
import net.uskizzik.skizzik.itemgroup.TemplateTabItemGroup;
import net.uskizzik.skizzik.item.MinigunItem;
...
public class MinigunSkizzieEntity extends SkizzikModElements.ModElement {
	public static EntityType entity = null;
	public MinigunSkizzieEntity(SkizzikModElements instance) {
		super(instance, 21);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.5999999999999999f))
						.build("minigun_skizzie").setRegistryName("minigun_skizzie");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -65536, -10092544, new Item.Properties().group(TemplateTabItemGroup.tab))
				.setRegistryName("minigun_skizzie_spawn_egg"));
	}
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelskizzie(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("skizzik:textures/minigun_skizzie.png");
					}
				};
			});
		}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				MinigunSkizzieRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				SkizziePlayerCollidesWithThisEntityProcedure.executeProcedure($_dependencies);
			}
		}

		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			MinigunItem.shoot(this, target);
		}
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		...
		public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing,
			...
			IVertexBuilder ivertexbuilder = bufferIn.getBuffer(RenderType.getEyes(new ResourceLocation("skizzik:textures/minigun_skizzie_glow.png")));
