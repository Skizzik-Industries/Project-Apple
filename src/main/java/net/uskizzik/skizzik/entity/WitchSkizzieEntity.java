...
import net.uskizzik.skizzik.procedures.WitchSkizzieRightClickedOnEntityProcedure;
import net.uskizzik.skizzik.procedures.WitchSkizziePlayerCollidesWithThisEntityProcedure;
...
public class WitchSkizzieEntity extends SkizzikModElements.ModElement {
	public static EntityType entity = null;
	public WitchSkizzieEntity(SkizzikModElements instance) {
		super(instance, 54);
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelwitch_skizzie(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("skizzik:textures/witch_skizzie.png");
					}
				};
			});
		}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				WitchSkizzieRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("sourceentity", sourceentity);
				WitchSkizziePlayerCollidesWithThisEntityProcedure.executeProcedure($_dependencies);
			}
		}
