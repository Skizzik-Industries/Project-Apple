...
public class CandyPlanksBlock extends SkizzikModElements.ModElement {
	@ObjectHolder("skizzik:candy_planks")
	public static final Block block = null;
	public CandyPlanksBlock(SkizzikModElements instance) {
		super(instance, 81);
	}
