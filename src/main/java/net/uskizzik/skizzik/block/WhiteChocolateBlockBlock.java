...
public class WhiteChocolateBlockBlock extends SkizzikModElements.ModElement {
	@ObjectHolder("skizzik:white_chocolate_block")
	public static final Block block = null;
	public WhiteChocolateBlockBlock(SkizzikModElements instance) {
		super(instance, 62);
	}
