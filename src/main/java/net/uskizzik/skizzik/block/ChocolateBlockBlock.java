...
public class ChocolateBlockBlock extends SkizzikModElements.ModElement {
	@ObjectHolder("skizzik:chocolate_block")
	public static final Block block = null;
	public ChocolateBlockBlock(SkizzikModElements instance) {
		super(instance, 63);
	}
