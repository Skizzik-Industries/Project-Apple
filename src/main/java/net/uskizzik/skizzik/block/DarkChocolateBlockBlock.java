...
public class DarkChocolateBlockBlock extends SkizzikModElements.ModElement {
	@ObjectHolder("skizzik:dark_chocolate_block")
	public static final Block block = null;
	public DarkChocolateBlockBlock(SkizzikModElements instance) {
		super(instance, 64);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_chocolate_block");
		}
