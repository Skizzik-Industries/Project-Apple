...
import net.uskizzik.skizzik.procedures.SkizzikHeadGemsBlockAddedProcedure;
...
public class SkizzikHeadGemsBlock extends SkizzikModElements.ModElement {
	@ObjectHolder("skizzik:skizzik_head_gems")
	public static final Block block = null;
	public SkizzikHeadGemsBlock(SkizzikModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1f, 1f).setLightLevel(s -> 6).notSolid()
					.setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true).setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
			setRegistryName("skizzik_head_gems");
		}
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			int z = pos.getZ();
			{
				...
				SkizzikHeadGemsBlockAddedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
