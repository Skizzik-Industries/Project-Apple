...
public class StrippedCandyLogBlock extends SkizzikModElements.ModElement {
	@ObjectHolder("skizzik:stripped_candy_log")
	public static final Block block = null;
	public StrippedCandyLogBlock(SkizzikModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.SLIME).hardnessAndResistance(2f, 2f).setLightLevel(s -> 0));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("stripped_candy_log");
		}
