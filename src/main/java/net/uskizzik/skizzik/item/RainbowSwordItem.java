...
public class RainbowSwordItem extends SkizzikModElements.ModElement {
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Right-click on a block to teleport it in another dimension"));
			}
			...
			public ActionResultType onItemUse(ItemUseContext context) {
				...
				ItemStack itemstack = context.getItem();
				{
					...
					RainbowSwordRightClickedOnBlockProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
