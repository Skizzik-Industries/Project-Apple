...
public class GreenGemItem extends SkizzikModElements.ModElement {
	@ObjectHolder("skizzik:green_gem")
	public static final Item block = null;
	public GreenGemItem(SkizzikModElements instance) {
		super(instance, 38);
	}
