...
public class PinkGemItem extends SkizzikModElements.ModElement {
	@ObjectHolder("skizzik:pink_gem")
	public static final Item block = null;
	public PinkGemItem(SkizzikModElements instance) {
		super(instance, 40);
	}
