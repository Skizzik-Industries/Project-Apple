...
import net.uskizzik.skizzik.procedures.SkizLauncher2BulletHitsPlayerProcedure;
import net.uskizzik.skizzik.procedures.SkizLauncher2BulletHitsBlockProcedure;
...
public class SkizLauncher2Item extends SkizzikModElements.ModElement {
	@ObjectHolder("skizzik:skiz_launcher_2")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletskiz_launcher_2").setRegistryName("entitybulletskiz_launcher_2"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("skiz_launcher_2");
		}
		...
		public void onUsingTick(ItemStack itemstack, LivingEntity entityLiving, int count) {
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 2f, 10, 1);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			World world = this.world;
			{
				...
				SkizLauncher2BulletHitsPlayerProcedure.executeProcedure($_dependencies);
			}
		}
			...
			if (this.inGround) {
				{
					...
					$_dependencies.put("z", z);
					$_dependencies.put("world", world);
					SkizLauncher2BulletHitsBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("skizzik:textures/skiz_head_2.png");
