...
public class DarkChocolateBarItem extends SkizzikModElements.ModElement {
	@ObjectHolder("skizzik:dark_chocolate_bar")
	public static final Item block = null;
	public DarkChocolateBarItem(SkizzikModElements instance) {
		super(instance, 54);
	}
