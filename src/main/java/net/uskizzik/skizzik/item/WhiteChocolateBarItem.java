...
public class WhiteChocolateBarItem extends SkizzikModElements.ModElement {
	@ObjectHolder("skizzik:white_chocolate_bar")
	public static final Item block = null;
	public WhiteChocolateBarItem(SkizzikModElements instance) {
		super(instance, 52);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("white_chocolate_bar");
		}
