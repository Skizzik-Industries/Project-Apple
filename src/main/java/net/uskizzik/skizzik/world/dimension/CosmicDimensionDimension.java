...
package net.uskizzik.skizzik.world.dimension;
...
public class CosmicDimensionDimension extends SkizzikModElements.ModElement {
	public CosmicDimensionDimension(SkizzikModElements instance) {
		super(instance, 301);
	}
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				ObfuscationReflectionHelper.setPrivateValue(WorldCarver.class, WorldCarver.CAVE, new ImmutableSet.Builder<Block>()
						...
						.add(CosmicUnderrackBlock.block.getDefaultState().getBlock()).build(), "field_222718_j");
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("skizzik:cosmic_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
