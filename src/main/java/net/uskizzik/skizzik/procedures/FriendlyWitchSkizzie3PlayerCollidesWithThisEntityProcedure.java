	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((!((new Object() {
			...
			if ((Math.random() < 0.01)) {
				...
				if (sourceentity instanceof LivingEntity)
					((LivingEntity) sourceentity).addPotionEffect(new EffectInstance(Effects.REGENERATION, (int) 1200, (int) 5, (false), (false)));
				if (sourceentity instanceof LivingEntity)
					((LivingEntity) sourceentity).addPotionEffect(new EffectInstance(Effects.FIRE_RESISTANCE, (int) 1200, (int) 5, (false), (false)));
				if (sourceentity instanceof LivingEntity)
					((LivingEntity) sourceentity).addPotionEffect(new EffectInstance(Effects.RESISTANCE, (int) 1200, (int) 5, (false), (false)));
			}
		}
	}
}
