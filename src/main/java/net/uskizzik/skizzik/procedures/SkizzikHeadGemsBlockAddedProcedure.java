...
public class SkizzikHeadGemsBlockAddedProcedure extends SkizzikModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) (y - 2), (int) z))).getBlock() == Blocks.REDSTONE_BLOCK.getDefaultState().getBlock())) {
			if (((world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) (z - 1)))).getBlock() == Blocks.REDSTONE_BLOCK.getDefaultState()
					.getBlock())) {
				if (((world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) (z + 1)))).getBlock() == Blocks.REDSTONE_BLOCK.getDefaultState()
						.getBlock())) {
					if (((world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) z))).getBlock() == CommandBlockBlock.block.getDefaultState()
							.getBlock())) {
						if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) (z + 1)))).getBlock() == SkizzikHeadBlock.block
								.getDefaultState().getBlock())) {
							if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) (z - 1)))).getBlock() == SkizzikHeadBlock.block
									.getDefaultState().getBlock())) {
								if (((world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) (z + 1)))).getBlock() == SkizzikHeadBlock.block
										.getDefaultState().getBlock())) {
			...
			} else if (((world.getBlockState(new BlockPos((int) (x - 1), (int) (y - 1), (int) z))).getBlock() == Blocks.REDSTONE_BLOCK
					.getDefaultState().getBlock())) {
				if (((world.getBlockState(new BlockPos((int) (x + 1), (int) (y - 1), (int) z))).getBlock() == Blocks.REDSTONE_BLOCK.getDefaultState()
						.getBlock())) {
					if (((world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) z))).getBlock() == CommandBlockBlock.block.getDefaultState()
							.getBlock())) {
						if (((world.getBlockState(new BlockPos((int) (x + 1), (int) y, (int) z))).getBlock() == SkizzikHeadBlock.block
							...
							if (((world.getBlockState(new BlockPos((int) (x - 1), (int) y, (int) z))).getBlock() == SkizzikHeadBlock.block
									.getDefaultState().getBlock())) {
								if (((world.getBlockState(new BlockPos((int) (x + 1), (int) (y + 1), (int) z))).getBlock() == SkizzikHeadBlock.block
										.getDefaultState().getBlock())) {
