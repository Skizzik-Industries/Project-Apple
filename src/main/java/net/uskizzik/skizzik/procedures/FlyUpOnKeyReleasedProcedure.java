...
public class FlyUpOnKeyReleasedProcedure extends SkizzikModElements.ModElement {
	public FlyUpOnKeyReleasedProcedure(SkizzikModElements instance) {
		super(instance, 285);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SkizzikMod.LOGGER.warn("Failed to load dependency entity for procedure FlyUpOnKeyReleased!");
			return;
		}
		...
		if ((((entity.getRidingEntity()) instanceof FriendlySkizzieEntity.CustomEntity)
			...
			(entity.getRidingEntity()).setMotion(((entity.getRidingEntity()).getMotion().getX()), 0, ((entity.getRidingEntity()).getMotion().getZ()));
		}
	}
}
